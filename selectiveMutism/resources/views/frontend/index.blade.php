...
<section class="page-section clearfix">
    <div>
        <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="public/img/bg.jpg" alt="">
        <p class="mb-3">we guarantee it!</p>
    </div>
    
    <div class="container">
        <div class="intro">
            <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="img/cuteAnimal1.jpg" alt="">
